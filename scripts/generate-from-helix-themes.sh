...
cargo build --package helix-theme-transformer-cli
mkdir -p "$out_dir"
...
Generated theme files were produced by Helix Theme Transformer from those Helix theme files.
CREDITS
